...
/* harmony import */ var _test__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./test */ "./js/test.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_test__WEBPACK_IMPORTED_MODULE_3__["testFunciton"])();
...
/*!********************!*\
  !*** ./js/test.js ***!
  \********************/
/*! exports provided: testFunciton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testFunciton", function() { return testFunciton; });
var nonBrSpace = String.fromCharCode(160);
var buttonAnchor = document.querySelector('.header__button--anchor');
var anchorButtonText = function anchorButtonText() {
...
anchorButtonText();
var services = document.querySelector('.services__container');
var servicesHeading = services.querySelector('h2');
var servicesHeadingText = function servicesHeadingText() {
  if (window.innerWidth >= 768) {
    servicesHeading.textContent = 'Smart Device предлагает следующие товары и услуги';
  } else {
    servicesHeading.textContent = "\u0422\u043E\u0432\u0430\u0440\u044B \u0438 \u0443\u0441\u043B\u0443\u0433\u0438 Smart".concat(nonBrSpace, "Device");
  }
};
servicesHeadingText();
var testFunciton = function testFunciton() {
  var textButton = document.querySelector('.button--transparent-blue');
  var textContainer = document.querySelector('.about__text');
  var displayedText = document.querySelector('.about__displayed');
  var hiddenText = document.querySelector('.about__hidden');
  ...
  var setRootStyles = function setRootStyles() {
    ...
    document.documentElement.style.setProperty('--displayed-text-height', "".concat(displayedText.offsetHeight, "px"));
    document.documentElement.style.setProperty('--hidden-text-height', "".concat(hiddenText.offsetHeight, "px"));
    document.documentElement.style.setProperty('--full-text-height', "".concat(displayedText.offsetHeight + hiddenText.offsetHeight, "px"));
    anchorButtonText();
    servicesHeadingText();
  };
  setRootStyles();
