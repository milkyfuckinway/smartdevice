...
/* harmony import */ var _modules_collapsible_text_init_collapsible__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/collapsible-text/init-collapsible */ "./js/modules/collapsible-text/init-collapsible.js");
/* harmony import */ var _modules_content_changing_init_content_changing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/content-changing/init-content-changing */ "./js/modules/content-changing/init-content-changing.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_collapsible_text_init_collapsible__WEBPACK_IMPORTED_MODULE_4__["initCollapsible"])();
    ...
    Object(_modules_content_changing_init_content_changing__WEBPACK_IMPORTED_MODULE_5__["initContentChanging"])();
  ...
  _createClass(Accordions, [{
    ...
    value: function updateAccordionsHeight() {
      ...
      closeElements.forEach(function (closeElement) {
        ...
        var changeTabIndex = function changeTabIndex(currentParent, elem) {
        ...
        var allParents = document.querySelectorAll('[data-accordion="parent"]');
        allParents.forEach(function (item) {
          var buttons = item.querySelectorAll('[data-accordion="button"');
...
var collapsible = function collapsible() {
  var collapsibleButton = document.querySelector('[data-collapsible-button]');
  var textContainer = document.querySelector('[data-collapsible-container]');
  var displayedContent = document.querySelector('[data-collapsible-displayed]');
  var hiddenContent = document.querySelector('[data-collapsible-hidden]');
  var originalText = collapsibleButton.textContent;
  var activeText = collapsibleButton.getAttribute('data-collapsible-text-active');
  if (collapsibleButton && textContainer && displayedContent && hiddenContent) {
    var setRootStyles = function setRootStyles() {
      document.documentElement.style.setProperty('--collapsible-displayed-height', "".concat(displayedContent.offsetHeight, "px"));
      document.documentElement.style.setProperty('--collapsible-hidden-height', "".concat(hiddenContent.offsetHeight, "px"));
      document.documentElement.style.setProperty('--collapsible-full-height', "".concat(displayedContent.offsetHeight + hiddenContent.offsetHeight, "px"));
    };
    setRootStyles();
...
/*!*********************************************************!*\
  !*** ./js/modules/collapsible-text/init-collapsible.js ***!
  \*********************************************************/
/*! exports provided: initCollapsible */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCollapsible", function() { return initCollapsible; });
/* harmony import */ var _collapsible__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./collapsible */ "./js/modules/collapsible-text/collapsible.js");

var initCollapsible = function initCollapsible() {
  Object(_collapsible__WEBPACK_IMPORTED_MODULE_0__["collapsible"])();
};
...
/*!*********************************************************!*\
  !*** ./js/modules/content-changing/content-changing.js ***!
  \*********************************************************/
/*! exports provided: contentChanging */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "contentChanging", function() { return contentChanging; });
var contentChanging = function contentChanging() {
  var changingElements = document.querySelectorAll('[data-content-changing]');
  changingElements.forEach(function (element) {
    var originalText = element.textContent;
    var mutatedText = element.getAttribute('data-content-changing');
    var mutateWidth = element.getAttribute('data-content-changing-width');
...
/*!**************************************************************!*\
  !*** ./js/modules/content-changing/init-content-changing.js ***!
  \**************************************************************/
/*! exports provided: initContentChanging */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initContentChanging", function() { return initContentChanging; });
/* harmony import */ var _content_changing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./content-changing */ "./js/modules/content-changing/content-changing.js");

var initContentChanging = function initContentChanging() {
  Object(_content_changing__WEBPACK_IMPORTED_MODULE_0__["contentChanging"])();
};
    ...
    value: function disableScrolling() {
      ...
      if (this._getScrollbarWidth()) {
        ...
        this._fixedBlockElements.forEach(function (block) {
          ...
          block.style.width = "calc(100% - ".concat(_this._getScrollbarWidth(), "px)");
        });
      }
